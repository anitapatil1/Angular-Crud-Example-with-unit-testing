...
import { UserService } from './user.service';
  ...
  describe('Blog Service', () => {
    ...
    it('should get all employee types', done => {
      //let blogService: BlogService;
      let employeetypeService: UserService;
      getTestBed().compileComponents().then(() => {
        mockBackend.connections.subscribe(
          ...
          employeetypeService = getTestBed().get(UserService);
          expect(employeetypeService).toBeDefined();
  
          employeetypeService.getUsers().subscribe( data => {
